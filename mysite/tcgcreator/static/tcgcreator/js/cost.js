	...
	$(document).ready(function(){
		...
		switch($("#id_cost_val").val()){
			case "10":
				$("#id_cost").after("<input type=\"button\" onclick=\"getShuffle('id_cost')\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
				break;
			case "37":
			case "48":
				$("#id_cost").after("<input type=\"button\" onclick=\"CopyEffect()\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
				$("#put_copy_effect").hide();
				break;
			case "35":
				$("#id_cost").after("<input type=\"button\" onclick=\"getCopyMonster(0)\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
				break;
			case "41":
			$("#id_cost").after("<input type=\"button\" onclick=\"getMonsterEffectCheckTimingAndPhase(0)\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
			break;
			case "5":
				...
				break;
		    case "25":
				$("#id_cost").after("<input type=\"button\" onclick=\"getMonsterEffectRelation('cost')\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
		        break;
		    case "17":
			...
			case "27":
			case "28":
			$("#id_cost").after("<input type=\"button\" onclick=\"getChainVariableChange('cost')\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
				break;
			case "63":
			case "64":
			$("#id_cost").after("<input type=\"button\" onclick=\"getGlobalVariableChange('cost')\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
				break;
			case "33":
				$("#id_cost").after("<input type=\"button\" onclick=\"getClearRelation(0)\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
				break;
			case "34":
				$("#id_cost").after("<input type=\"button\" onclick=\"getChangeValByMonster(0)\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
				break;
			}
...
'success': function(data){
	...
	function putMonsterVariableChange(){
		...
		json["monster_variable_change_val"] = $("#monster_variable_change_val").val();
	...
	function  hideAllWindow(){
		...
		// monster_effect_change_valは３４でしか使わないので消す
...
'success': function(data){
	...
	function getCopyMonster(){
		getConditionKind("cost",35,100,0);
