...
class CostAdmin(admin.ModelAdmin):
    ...
    class Media:
        ...
        css = {
            "all": ["https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.css"]
        }
...
class TriggerTimingRelationAdmin(admin.ModelAdmin):
    ...
    class Media:
        css = {
            "all": ["css/common.css","https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.css"]
        }
        js = [
             "https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js",
            "https://code.jquery.com/jquery-3.6.0.min.js",
...
class FieldAdmin(admin.ModelAdmin):
    ...
    class Media:
        ...
        js = [ 
            "https://code.jquery.com/jquery-3.6.0.min.js",
             "https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js",
                "tcgcreator/js/field_kind.js", "tcgcreator/js/ajax.js"]
