	...
	$(document).ready(function(){
		...
		switch($("#id_monster_effect_val").val()){
				case "81":
				$("#id_monster_effect").after("<input type=\"button\" onclick=\"getMonsterEffectPutNum('monster_effect')\" value=\"追加\"><input type=\"button\" onclick=\"deleteMonsterEffect(0)\" value=\"削除\"><br>");
					break;
	...
	function getChangeValByMonster2(){
