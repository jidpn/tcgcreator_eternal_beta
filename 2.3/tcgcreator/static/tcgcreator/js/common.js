...
'success': function(data){
	...
	function showEquationDet(){
		...
		getPlaceForEquation();
		$("#cond_for_editor0").autocomplete(
			{source:"/tcgcreator/monster_variable_autocomplete/"}
		);
		$("#value_for_editor0").autocomplete({
			source: function (request, response) {
				var data = {q:$("#cond_for_editor0").val()};
				$.ajax({
			  		type: "GET",
			  		url:"/tcgcreator/monster_variable_kind_autocomplete/",
...
'success': function(data){
    ...
    function addCond(num){
		...
		$("#cond_for_editor"+num).autocomplete(
			{source:"/tcgcreator/monster_variable_autocomplete/"}
		);
		$("#value_for_editor"+num).autocomplete({
			source: function (request, response) {
				var data = {q:$("#cond_for_editor"+num).val()};
				$.ajax({
			  		type: "GET",
			  		url:"/tcgcreator/monster_variable_kind_autocomplete/",
			  		contentType: "application/json; charset=utf-8",
