...
urlpatterns = [
    ...
    re_path(r"^monster_variable_autocomplete/$",autocomplete.monster_variable_autocomplete,name="monster_variable_autocomplete"),
    re_path(r"^monster_variable_kind_autocomplete/$",autocomplete.monster_variable_kind_autocomplete,name="monster_variable_kind_autocomplete"),
    re_path(
    ...
    re_path(r"^download_card/$", views.download_card, name="download_card"),
    re_path(r"^get_effect_kind/$", views.get_effect_kind, name="get_effect_kind"),
    re_path(r"^field_list_view/$", views.field_list_view, name="field_list_view"),
    re_path(r"^field_list_view_x/$", views.field_list_view_x, name="field_list_view_x"),
