...
from .models import MonsterVariables, MonsterVariablesKind, Monster, MonsterItem, Field,MINE_OR_OTHER
from django.contrib.auth.forms import UserCreationForm
from pprint import pprint

class FieldXForm(forms.Form):
    no_clear = forms.BooleanField(label="no_clear",required=False,widget=forms.CheckboxInput(attrs={'class':'check'}))
    box = forms.BooleanField(label="box",required=False,widget=forms.CheckboxInput(attrs={'class':'check'}))
    color = forms.CharField(label = "color",required=False,widget=forms.TextInput())
    kind = forms.CharField(label = "kind",required=False,widget=forms.TextInput())
    sentence = forms.CharField(label = "sentence",required=False,widget=forms.TextInput())
    mine_or_other = forms.ChoiceField(label="mine_or_other",required=True,widget=forms.Select,choices=MINE_OR_OTHER)
